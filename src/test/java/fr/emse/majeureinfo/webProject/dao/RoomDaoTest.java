...
public class RoomDaoTest {
    ...
    private static final Operation DELETE_ALL = DeleteAll.from("ROOM", "NOISE", "LIGHT");
    @Autowired
    ...
    protected void dbSetup(Operation op1, Operation op2, Operation op3) {
        DbSetup setup = new DbSetup(new DataSourceDestination(dataSource),
                Operations.sequenceOf(DELETE_ALL, op1, op2, op3));
